...
function buildDealAnalysis(deal, comps, neighborhoods, lenders = [], selectedLenderId = "") {
  ...
  const estimatedFlipProfit = underwritingMetrics.profit;
        ...
        .map((deal, index) => {
          ...
          try {
            ...
            return {
              ...
              dealScore: backendRecord?.dealScore ?? computed.dealScore,
              ...
              estimatedProfit: computed.estimatedProfit ?? computed.estimatedFlipProfit ?? 0,
