  ...
  try {
    ...
    if (segments[0] === "api" && segments[1] === "comps") {
      ...
      if (req.method === "POST" && segments[2] === "sold-comps") {
        ...
        sendJson(res, 200, { ok: true, status: records.length > 0 ? "Success" : "No Qualifying Comps", errorCode: null, records: importedRecords, resultCount: importedRecords.length, providerSummary: providerResults.providerResults || [] });
        return;
      }
