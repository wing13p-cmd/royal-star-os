          ...
          <div style={styles.gridTwo}>
            <div style={styles.section}>
              ...
              <div style={styles.providerPanel}>
                ...
                <div style={styles.providerMeta}>{providerSearchState.summary || (providerStatus.configured ? "Ready for a safe provider lookup." : "Manual mode only until a local RentCast key is configured.")}</div>
