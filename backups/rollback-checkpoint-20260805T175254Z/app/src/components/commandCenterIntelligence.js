...
export function buildCommandCenterIntelligence(payload = {}) {
  ...
  const alerts = normalizeArray(portfolioIntelligence?.alerts).length ? normalizeArray(portfolioIntelligence.alerts) : hasPortfolioIntelligence ? executiveAlerts : buildAlerts(deals, properties, rehabProjects, contractors, lenders, portfolioIntelligence);
  const priorities = normalizeArray(portfolioIntelligence?.priorities).length ? normalizeArray(portfolioIntelligence.priorities) : hasPortfolioIntelligence ? [...executivePriorities, ...nextBestActionPriorities] : buildPriorities(deals, properties, rehabProjects, lenders, portfolioIntelligence);
