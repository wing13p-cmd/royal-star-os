...
export function buildEnterpriseMonitoringEngine() {
  ...
  async function detectAndRecoverStalledWorkflows(config = {}) {
    const stallThresholdMs = safeNumber(config.stallThresholdMs || 1000 * 60 * 3);
    const recovered = [];
