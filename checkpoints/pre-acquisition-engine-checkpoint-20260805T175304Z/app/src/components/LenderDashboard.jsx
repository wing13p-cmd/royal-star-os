...
function createId(prefix = "lender") {
...
export default function LenderDashboard({ onBack, onOpenDealAnalyzer, onOpenFlipAnalyzer, onOpenBrrrrAnalyzer, onOpenProductVault, onOpenContractorHub, onOpenCompDatabase, onOpenDealIntelligence, onOpenNeighborhoodDatabase, onOpenPortfolioDashboard, onOpenPropertyDatabase, onOpenVendorDatabase, onOpenMaterialMatrix, onOpenDealIntake }) {
  ...
  const visibleLenders = useMemo(() => {
    ...
    return filtered;
  }, [normalizedLenders, search, typeFilter, purposeFilter, approvalFilter, activeFilter, preferredFilter, favoriteFilter, refiFilter, rehabFilter, recourseFilter, stateFilter, maxRateFilter, maxPointsFilter, minScoreFilter, maxDrawFilter, sortBy, averageInterestRate, averagePoints]);
